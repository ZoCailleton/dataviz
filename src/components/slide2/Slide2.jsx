            ...
            <div className="inner flex">
                ...
                <div className="slide paris-map">
                    <div className="btn-container">
                        ...
                        {quarter !== 3 && <div onClick={() => setQuarter(3)} className="btn btn-2">Terroire aisé</div>}
